<script lang="ts">
	...
	let statusCode: number = $state(119);
...
<div
	class="flex flex-col items-center justify-start bg-fuchsia-500 md:flex-row md:items-start md:justify-around"
>
	...
	<div class="flex flex-col items-center justify-start bg-amber-500 px-5 py-2 md:px-24 md:pt-30">
		<InfoBar {statusCode} />
	</div>
</div>
